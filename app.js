...
console.log("Exercise 4 Result", generateEmail("Chris","Example.com"));
...
const greetUser = (name,time) => {
    return `Good ${time.toLowerCase()}, ${name}!`
}
...
console.log("Exercise 8 Result", convertTemperature(32,"C"), convertTemperature(32,"F"));
...
const basicCalculator = (x,y,method) => {
    let result = `${x} ${y} ${method}`;
